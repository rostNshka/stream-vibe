...
class Tabs extends BaseComponent {
  ...
  updateNavigationCSSVars(
    activeButtonElement = this.buttonElements[this.stateClasses.activeTabIndex]
  ) {
  ...
  previousTab = () => {
    const newTabIndex = this.stateClasses.activeTabIndex === 0
      ? this.limitTabsIndex
      : this.stateClasses.activeTabIndex - 1

    this.activateTab(newTabIndex)
  }

  nextTab = () => {
    const newTabIndex = this.stateClasses.activeTabIndex === this.limitTabsIndex
      ? 0
      : this.stateClasses.activeTabIndex + 1
